...
* **2-Second Strict SLA:** Monitors LLM API response times in real-time. If latency exceeds the 2.0-second limit or network failures occur, Hexagon automatically halts the request.
